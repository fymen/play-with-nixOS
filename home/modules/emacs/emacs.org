...
#+begin_src emacs-lisp :tangle yes
  ...
  (when (eq system-type 'gnu/linux)
    (if window-system
        ...
        (dolist (charset '(kana han symbol cjk-misc bopomofo))
          (set-frame-font (concat "Inconsolata LGC Nerd Font Mono " (number-to-string my-font-size)))
  ...
  (add-to-list 'default-frame-alist '(font . "Inconsolata LGC Nerd Font Mono 9"))
#+end_src
*** All the icons
#+begin_src emacs-lisp :tangle yes :lexical no
...
(use-package cursor-chg
  ...
  :defer 1
  :config
  (setq curchg-default-cursor-color "IndianRed")
...
(use-package elfeed
  ...
  (setq elfeed-show-mode-hook
        (lambda ()
	      (set-face-attribute 'variable-pitch (selected-frame) :font (font-spec :family "Open Sans" :size (+ my-font-size 5)))
...
(use-package edwina
  ...
  (edwina-mode 1)
  ;; (define-key edwina-mode-map (kbd "M-d") nil)
  ;; (define-key edwina-mode-map (kbd "M-<return>") nil)
  )
#+end_src
...
(use-package theme-changer
  :defer 60
  :config
  (setq calendar-location-name "Newyork, US")
  (setq calendar-latitude 43.6)
  (setq calendar-longitude -79.3)
  (change-theme 'doom-one-light 'doom-one)  ;; day and night theme
  )
